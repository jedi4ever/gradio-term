...
```bash
pip install gradio_gradioterminal
```
...
import gradio as gr
from gradio_gradioterminal import GradioTerminal
...
with gr.Blocks() as demo:
    terminal1 = GradioTerminal(value="'Hello from \x1B[1;3;31mxterm.js\x1B[0m $ '")  # interactive version of your component
...
if __name__ == "__main__":
    demo.launch()
#    demo.launch(allowed_paths=["frontend/node_modules/xterm/css/xterm.css"])
...
""", elem_classes=["md-custom"], header_links=True)
    ...
    gr.ParamViewer(value=_docs["GradioTerminal"]["members"]["__init__"], linkify=[])


    gr.Markdown("### Events")
    gr.ParamViewer(value=_docs["GradioTerminal"]["events"], linkify=['Event'])
...
def predict(
    ...
    return value
```
""", elem_classes=["md-custom", "GradioTerminal-user-fn"], header_links=True)
